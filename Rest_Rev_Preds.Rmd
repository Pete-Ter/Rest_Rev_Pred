...
train <- select(train, Type, Open.days, City.gr, revenue, P2.ind.2, P2.ind.3, P3.ind.6, P3.ind.5, P17.ind, P18.ind.4, P18.ind.12, P36.ind.3, P11, P36, P2, P3, P17, P18)
...
```{r crossval}
mean.met <- CrossVal(train, 'revenue', as.formula(rf.form), 10, 2, rFGrid)
